...
function parsePort(arg) {
    const errMsg = "Option `--port` must be a valid integer in the range 1..65535";
...
function parseHost(arg) {
    const errMsg = "Option `--host` must be an IPv4 address like x.x.x.x where x is 0..255";
